...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const productList = document.querySelectorAll('.main-product');
  ...
  searchForm.addEventListener('submit', function(event) {
      ...
      productList.forEach(function(product) {
          const productName = product.querySelector('.content-product-h3').textContent.toLowerCase();
...
const contactLinks = contactToolbar.querySelectorAll('a');
